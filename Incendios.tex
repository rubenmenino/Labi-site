...
\begin{figure}[H]
\center
\includegraphics[width=5cm]{Imagens/circular.png}
\caption{Causas dos incêndios florestais investigados pela GNR. (Fonte: ICNF- 2016)}
\end{figure}
...
\begin{figure}[H]
\center
\includegraphics[width=5cm]{Imagens/barras.png}
\caption{Número de incêndios florestais e área ardida em hectares.  (Fonte: ICNF, 2016)}
\end{figure}
